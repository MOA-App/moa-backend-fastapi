...
class TestCreatePermissionUseCase:
    ...
    async def test_creates_permission_successfully(
        self, usecase, mock_permission_repository
    ):
...
class TestGetPermissionUseCase:
    ...
    async def test_returns_permission_when_found(
        self, usecase, mock_permission_repository
    ):
...
class TestListResourcesUseCase:
    ...
    async def test_returns_empty_when_no_permissions(
        self, usecase, mock_permission_repository
    ):
...
class TestBulkCreatePermissionsUseCase:
    ...
    async def test_creates_multiple_permissions(
        self, usecase, mock_permission_repository
    ):
        perms = [
            make_permission("users.create"),
