...
class ProductRepositoryImpl(ProductRepositoryInterface):
    ...
    async def create(self, entity: ProductEntity) -> ProductEntity:
        ...
        try:
            ...
            # Ex: SKU duplicado ou category_id inexistente (FK)
            raise ProductIntegrityException(details=str(e.orig) if e.orig else str(e))
        except (DBAPIError, ConnectionRefusedError) as e:
            await self.session.rollback()
            raise ProductDatabaseConnectionException(details=str(e))
        except SQLAlchemyError as e:
            await self.session.rollback()
            raise ProductRepositoryException(operation="criar", details=str(e))
    ...
    async def get_by_id(self, product_id: str) -> Optional[ProductEntity]:
        ...
        try:
            ...
            raise ProductRepositoryException(operation="buscar por ID", details=str(e))
    ...
    async def get_by_sku(self, sku: str) -> Optional[ProductEntity]:
        ...
        try:
            ...
            raise ProductRepositoryException(operation="buscar por SKU", details=str(e))
    ...
    async def get_all(self, skip: int = 0, limit: int = 100) -> List[ProductEntity]:
        ...
        try:
            ...
            raise ProductRepositoryException(operation="listar", details=str(e))
    ...
    async def get_by_category(self, category_id: str) -> List[ProductEntity]:
        ...
        try:
            ...
            raise ProductRepositoryException(operation="listar por categoria", details=str(e))
    ...
    async def update(self, entity: ProductEntity) -> Optional[ProductEntity]:
        ...
        try:
            ...
            await self.session.rollback()
            raise ProductRepositoryException(operation="atualizar", details=str(e))
    ...
    async def delete(self, product_id: str) -> bool:
        ...
        try:
            ...
            await self.session.rollback()
            raise ProductRepositoryException(operation="excluir", details=str(e))
    ...
    async def get_active(self) -> List[ProductEntity]:
        ...
        try:
            ...
            raise ProductRepositoryException(operation="listar ativos", details=str(e))
    ...
    async def search_by_name(self, name: str) -> List[ProductEntity]:
        ...
        try:
            ...
            raise ProductRepositoryException(operation="buscar por nome", details=str(e))
    ...
    async def count(self) -> int:
        ...
        try:
            ...
            raise ProductRepositoryException(operation="contar", details=str(e))
    ...
    async def count_by_category(self, category_id: str) -> int:
        ...
        try:
            ...
            raise ProductRepositoryException(operation="contar por categoria", details=str(e))
